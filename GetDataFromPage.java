...
public class GetDataFromPage {
	...
	public ArrayList<String> GetData(String CarRegNum) throws InterruptedException{
		
		ArrayList<String> listOfValuesFromPage;
		listOfValuesFromPage = new ArrayList<>();
		
		System.setProperty("webdriver.chrome.driver", "C:\\Krupa\\Software\\chromedriver_win32\\chromedriver.exe");
		WebDriver chromeDriver1 = new ChromeDriver();
		
		chromeDriver1.get("https://cartaxcheck.co.uk/");
